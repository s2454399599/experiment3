...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String weatherUrl = "https://devapi.qweather.com/v7/weather/now?location=%s&key=%s";//和风天气 免费的api接口
    private String cityId;//具体城市天气id，如湛江，"weather_id"=CN101281001

    //注册和风天气开发者https://dev.heweather.com/
    //创建的apk 的 用户id 以及 该apk的key（包名要一致）
    private String userName = "HE2011291840411902";
    private String key = "aeb9bb44908c47658d61daef3342a7ad";//自己申请的key
